  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-amber-400 selection:text-black">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Luxury Shop Footer */}
        <footer className="mt-20 border-t border-white/10 pt-8 pb-12 flex flex-col md:flex-row items-center justify-between gap-6 font-mono text-xs text-zinc-500">
          <div className="flex items-center gap-3">
            <span className="font-sans font-black tracking-widest text-white">JERSEY VERSE</span>
            <span>© 2026 OFFICIAL STORE</span>
          </div>
